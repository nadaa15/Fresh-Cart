...
export default function CategoryProducts() {
  ...
  return (
    <>
      <Helmet>
        <title>{`${name} - Shop by Category`}</title>
        <meta
          name="description"
          content={`Explore the latest products in the ${name} category. Find top-quality items and great deals on Fresh-Card.`}
        />
      </Helmet>
      <>
        {products === null ? (
              ...
              <>
                <div className="bg-gray-200 p-12 container flex flex-col justify-center items-center rounded">
                  <h3 className="text-lg font-bold">
                    There are no items from this category
                  </h3>
                </div>
              </>
            )}
